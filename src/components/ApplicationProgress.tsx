...
const stages = [
  ...
  { id: 'interview_hc', label: 'Interview HC', icon: Users },
  { id: 'interview_user', label: 'Interview User', icon: Users },
  { id: 'psikotes', label: 'Psikotes', icon: Brain },
  { id: 'test_bidang', label: 'Test Bidang', icon: ClipboardList },
